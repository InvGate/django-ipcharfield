...
from db_field.utils import leading_zeros_repr_with_delimiter_from_partial_string_ip
...
def make_leading_zeros_for_already_completed_chunks(chunks, delimiter, chunks_size):
    return leading_zeros_repr_with_delimiter_from_partial_string_ip(delimiter.join(chunks),
